  ...
  try{
    ...
    //validation of empty fields
      if(isset($_POST['signup'])){
        ...
        $result = mysql_query($connection,"insert into admininfo(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
